...
public class PJpanel1 extends JPanel implements MouseMotionListener,MouseListener{
...
//	List<Gift>gifts=new ArrayList<Gift>();
	...
	public PJpanel1(){
		try {
			pImg=ImageIO.read(new File("Image/yxj2.png"));//控制的飞机
		...
		Thread t= new Thread(){
			public void run(){
				while(true){
					...
					//产生boss
					if(y==-2000&&ccount==2){
						Boss bs=new Boss(100, 10, (int)(Math.random()*2), 80, bossImg);
						boss.add(bs);
						fb=true;
